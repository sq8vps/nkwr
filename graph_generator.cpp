...
static void SaveGraph(std::ofstream &file, int n)
{
...
std::string GraphGenerate(std::string n)
{
    ...
    if(file.good())
    {
        ...
        SaveGraph(newFile, n_number); // Create and save new graph to file
        newFile.close();
    }
    else
    {
    ...
    std::cout << "Saved generated matrix in " << path << std::endl;
    return path;
}
